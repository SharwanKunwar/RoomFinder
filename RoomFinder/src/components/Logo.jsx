...
function Login() {
  ...
  return (
    <div className="bg-[#D0D5D7] w-screen h-screen flex justify-center items-center">
      <div className="w-[70%] h-[90%] flex shadow-xl rounded-2xl overflow-hidden">
        ...
        <div className="w-6/12 relative">
          ...
          />
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-black/70 via-black/30 to-transparent flex flex-col justify-end px-10 py-6">
            <div className="flex items-center gap-2 h-10">
              <AnimatedTooltipPreview />
              <p className="text-neutral-400 text-sm">Verified community members</p>
            </div>
              ...
              {["seeker", "owner"].map((r) => (
                <div
                  ...
                  className={`flex-1 text-center py-2 rounded-lg border cursor-pointer transition-all
                    ${role === r ? "border-black/50 bg-indigo-400 text-white shadow-md" : "border-gray-300 hover:border-indigo-400"}
                  `}
                >
